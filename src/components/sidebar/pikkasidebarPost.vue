<template>
  ...
  <div class="pikka_body_2">
    ...
    <!-- 다른 컴포넌트도 추가할 수 있습니다. -->
    <QandADetail v-if="selectedItem === '문의사항'" />
    <QandAForm v-if="selectedItem === '문의사항'" />
    <QandAList v-if="selectedItem === '문의사항'" />
  </div>
</template>

<script>
import NoticeManagement from "../views/Notice.vue"; // 공지사항 컴포넌트 import
import QandAList from "../components/QandA/QandAList.vue"; // Q&A 컴포넌트 import
import QandADetail from "../components/QandA/QandADetail.vue"; // Q&A 컴포넌트 import
